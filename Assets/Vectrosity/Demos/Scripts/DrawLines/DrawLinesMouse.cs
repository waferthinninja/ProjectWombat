    ...
    public class DrawLinesMouse : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (line3D)
                ...
                line = new VectorLine("DrawnLine", new List<Vector2>(), tex, useLineWidth, LineType.Continuous,
                    Joins.Weld);
        ...
        private void Update()
        {
            ...
            // Mouse button held down and mouse has moved far enough to make a new point
                     ...
                     (Input.mousePosition - previousPosition).sqrMagnitude > sqrMinPixelMove && canDraw)
            {
                previousPosition = Input.mousePosition;
                int pointCount;
                if (line3D)
                ...
                if (pointCount >= maxPoints) canDraw = false;
            }
        }
