...
namespace Vectrosity.Demos.Scripts.Grid3D
{
    public class Grid3D : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                transform.Translate(new Vector3(Input.GetAxis("Horizontal") * Time.deltaTime * moveSpeed, 0,
        ...
        {
            GUILayout.Label(
                " Use arrow keys to move camera. Hold Shift + arrow up/down to move vertically. Hold Shift + arrow left/right to rotate.");
        }
    }
}